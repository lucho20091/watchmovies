...
- **Language**: The project currently uses JavaScript (`.js`/`.jsx`) and should remain using JavaScript.
...
- **Javascript**:
  - All new components, hooks, and utility files should be written in JavaScript (`.jsx` or `.js`).
- **Tailwind CSS**:
